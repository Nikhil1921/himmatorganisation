...
class Program extends Admin_controller {
	...
	protected $redirect = 'program';
	protected $name = 'program';
	protected $title = 'program';
	protected $table = 'program';
    public $uploadPath = "assets/images/program/";
    ...
    public function get()
    {
        $this->load->model('program_model', 'data');
    ...
    public function update($id)
    {
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $data['data'] = $this->main->get($this->table, 'title, details, CONCAT("'.$this->uploadPath.'", image) image, image img', ['id' => d_id($id)]);
