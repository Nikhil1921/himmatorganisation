...
class Home extends Admin_controller {
	...
	public function index()
	{
        ...
        $data['program'] = $this->program_model->count();
        $data['gallery'] = $this->gallery_model->count();
        $data['trustee'] = $this->trustee_model->count();
        $data['media'] = $this->media_model->count();
        $data['compliance'] = $this->compliance_model->count();
        $data['report'] = $this->report_model->count();
        $data['partner'] = $this->partner_model->count();
        $data['banner'] = $this->banner_model->count();
